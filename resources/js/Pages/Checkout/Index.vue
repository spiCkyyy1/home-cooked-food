<template>
    <div class="container mx-auto mt-8 mb-8">
        ...
        />
      <button type="button" @click="submit" class="text-gray-900 bg-white hover:bg-gray-100 border border-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-gray-800 dark:bg-white dark:border-gray-700 dark:text-gray-900 dark:hover:bg-gray-200 mr-2 mb-2">
...
export default {
    ...
    data(){
        return {
            publishableKey: 'pk_test_51O9bMuESojByfVftwNYRV65ig15O717zDRSYGZjuXzJ8vtq6gEyUMcRuVvr3SlPQMk9WmzXq2bhX14uWoOYlSDAh00x5tJeT78',
            sessionId: null,
            lineItems: '',
            successURL: '',
            cancelURL: '',
    ...
    methods: {
        getSession(){
            axios.post(this.baseURL+'/session', {amount: this.amount, products: this.products})
                .then(response => {
