    ...
    <div class="bg-white" v-show="menus.data">
        <div class="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
            ...
            <div class="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                <div v-for="menu in menus.data" v-show="showStore(menu)" :key="menu.id">
                    ...
                    <div class="mt-4 flex justify-between">
                        ...
                        <div class="flex flex-row-reverse justify-end items-center">
                            <input :id="'hs-ratings-readonly'+menu.id" v-if="menu.rating" v-model="menu.rating" type="radio" class="peer -ms-5 w-5 h-5 bg-transparent border-0 text-transparent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0"  value="1">
                            ...
                            <input :id="'hs-ratings-readonly'+menu.id" v-if="menu.rating" v-model="menu.rating" type="radio" class="peer -ms-5 w-5 h-5 bg-transparent border-0 text-transparent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0"  value="2">
                            ...
                            <input :id="'hs-ratings-readonly'+menu.id" v-model=menu.rating type="radio" class="peer -ms-5 w-5 h-5 bg-transparent border-0 text-transparent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0"  value="3">
                            ...
                            <input :id="'hs-ratings-readonly'+menu.id" v-model="menu.rating" type="radio" class="peer -ms-5 w-5 h-5 bg-transparent border-0 text-transparent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0"  value="4">
                            ...
                            <input :id="'hs-ratings-readonly'+menu.id" v-model="menu.rating" type="radio" class="peer -ms-5 w-5 h-5 bg-transparent border-0 text-transparent cursor-pointer appearance-none checked:bg-none focus:bg-none focus:ring-0 focus:ring-offset-0"  value="5">
